...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="views/templates/css/font-awesome.min.css">
  <!-- Ionicons -->
  <link rel="stylesheet" href="views/templates/css/ionicons.min.css">
  <!-- Theme style -->
  <link rel="stylesheet" href="views/templates/css/AdminLTE.min.css">

  <link rel="stylesheet" href="views/templates/css/_all-skins.min.css">
        ...
        <ul class="nav navbar-nav">
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="views/templates/img/user2-160x160.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php //echo $_SESSION['username'];  ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="views/templates/img/user2-160x160.jpg" class="img-circle" alt="User Image">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="home.php?action=list"><i class="fa fa-circle-o"></i> Danh sách sản phẩm</a></li>
