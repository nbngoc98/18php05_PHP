    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="admin.php?controller=list&action=listProduct"><i class="fa fa-circle-o"></i> Danh sách sản phẩm</a></li>
            <li><a href="admin.php?controller=list&action=add"><i class="fa fa-circle-o"></i> Thêm sản phẩm</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
