...
<html lang="en">
	<head>
		...
		<link href="public/themes/css/jquery.fancybox.css" rel="stylesheet"/>
		...
		<script src="public/themes/js/jquery.fancybox.js"></script>
		<!--[if lt IE 9]>			
			...
			<section class="main-content">				
				<div class="row">						
					...
					echo "
						<div class='row'>
							<div class='span4'>
								<a href='public/themes/images/ladies/1.jpg' class='thumbnail' data-fancybox-group='group1' title='Description 1'><img src='$image' width='70%'></a>						
							</div>
							<div class='span5'>
								<address>
									<strong>Name:</strong> <span>" . $row['name']. "</span><br>
									<strong>Product ID:</strong> <span>" . $row['id']. "</span><br>
